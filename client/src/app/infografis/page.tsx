    ...
    export default async function InfografisListPage() {
    const res = await getPostsByCategory("infografis");
    const items = res?.data || [];

    return (
        <main className="bg-gray-50 py-12">
        <div className="container mx-auto px-4">
            <h1 className="text-3xl font-bold mb-8 text-gray-800">Infografis</h1>

            {items.length === 0 && (
            <p className="text-gray-500">Tidak ada infografis tersedia.</p>
            )}
